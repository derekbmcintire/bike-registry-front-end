...
var clearCreateBicycle = function clearCreateBicycle() {
  $('#bicycle-make').val('');
  $('#bicycle-model').val('');
  $('#bicycle-color').val('');
  $('#serial-number').val('');
...
var clearUpdateBicycle = function clearUpdateBicycle() {
  $('#update-make').val('');
  $('#update-model').val('');
  $('#update-color').val('');
  $('#update-number').val('');
...
var config = {
  apiOrigins: {
    production: 'https://aqueous-brook-70100.herokuapp.com',
...
var showCreateBicycle = function showCreateBicycle() {
  clear.clearAll();
  $('#message').text('');
...
var onCreateBicycle = function onCreateBicycle(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createBicycle(data).then(ui.createBicycleSuccess).catch(ui.createBicycleFailure);
};

// get all my bicycles
var onGetMyBicycles = function onGetMyBicycles() {
  api.getMyBicycles().then(ui.getMyBicyclesSuccess).catch(ui.getBicyclesFailure);
};

// get all bicycles callback function
var onGetBicycles = function onGetBicycles() {
  api.getBicycles().then(ui.getBicyclesSuccess).catch(ui.getBicyclesFailure);
};

// show the search form
var showFindBicycle = function showFindBicycle() {
  clear.clearAll();
  $('#search-form').show();
};

// search bicycles callback function
var onSearchBicycles = function onSearchBicycles(event) {
  event.preventDefault();
  store.targetData = $('#bike-search').val().split(' ');
  api.getBicycles(store.targetData).then(ui.searchBicyclesSuccess).catch(ui.searchBicyclesFailure);
};

var onGetStolenBicycles = function onGetStolenBicycles() {
  api.getBicycles().then(ui.getStolenBicyclesSuccess).catch(ui.getBicyclesFailure);
};
...
var createBicycle = function createBicycle(data) {
  return $.ajax({
...
var getBicycles = function getBicycles() {
  return $.ajax({
    url: config.apiOrigin + '/bicycles',
    method: 'GET',
    headers: {
...
var getMyBicycles = function getMyBicycles() {
  return $.ajax({
...
var deleteBicycle = function deleteBicycle() {
  return $.ajax({
...
var updateBicycle = function updateBicycle(data) {
  return $.ajax({
    url: config.apiOrigin + '/bicycles/' + store.updateId,
    method: 'PATCH',
    headers: {
...
var registerStolen = function registerStolen(data) {
  return $.ajax({
...
var recoverStolen = function recoverStolen(data) {
  return $.ajax({
    url: config.apiOrigin + '/events',
    method: 'POST',
    headers: {
...
module.exports = {
  ...
  updateBicycle: updateBicycle,
  getMyBicycles: getMyBicycles,
  registerStolen: registerStolen,
  // getStolenBicycles,
  recoverStolen: recoverStolen
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var bicycleEvents = __webpack_require__(9);
var signInUp = __webpack_require__(42);
...
var load = __webpack_require__(41);
...
var showChangePassword = function showChangePassword() {
  ...
  $('.main').hide();
  $('#abort-change-pw').on('click', function () {
    $('#message-top').text('');
    $('#old-password').val('');
    $('#new-password').val('');
    $('#change-pw-container').hide();
...
var store = __webpack_require__(2);
var clear = __webpack_require__(4);
var bicycles = __webpack_require__(9);
...
var switchSignIn = function switchSignIn() {
...
var switchSignUp = function switchSignUp() {
  $('#subtitle').text('A community based resource for getting your bike back.');
  $('#sign-message').text('');
  $('#sign-in-email').val('');
  $('#sign-in-password').val('');
...
var store = __webpack_require__(2);
var res = __webpack_require__(21);
var showBicyclesTemplate = __webpack_require__(23);
var searchBicyclesTemplate = __webpack_require__(40);
var clear = __webpack_require__(4);

// display message on create bicycle success
var createBicycleSuccess = function createBicycleSuccess(data) {
  clear.clearAll();
  $('#message').text('Bike successfully created');
};

// display message on create bicycle failure
var createBicycleFailure = function createBicycleFailure() {
  $('#message').text('Please fill out all fields');
};

// display message on get all bicycles success
var getBicyclesSuccess = function getBicyclesSuccess(data) {
  $('#register-form').off('submit');
  $('.register-stolen').off('click');
  store.data = data;
  var showBicyclesHtml = showBicyclesTemplate({ bicycles: data.bicycles });
  clear.clearAll();
...
// display message on get all bicycles success
var getMyBicyclesSuccess = function getMyBicyclesSuccess(data) {
  // $('#register-form').off('submit')
  // $('.register-stolen').off('click')
  store.data = data;
  var showBicyclesHtml = showBicyclesTemplate({ bicycles: data.bicycles });
...
var getBicyclesFailure = function getBicyclesFailure() {
  $('#message').text('Error getting bike');
};

var getStolenBicyclesSuccess = function getStolenBicyclesSuccess(data) {
  store.data.bicycles = data.bicycles.filter(function (bike) {
    return bike.stolen === true;
  });
  var showBicyclesHtml = showBicyclesTemplate({ bicycles: store.data.bicycles });
  clear.clearAll();
  $('.display-results').append(showBicyclesHtml);
...
var matchBicycle = function matchBicycle(arr, bikes) {
  ...
  result = bikes.filter(function (bike) {
    ...
    Object.values(bike).slice(0, 6).forEach(function (value) {
      // normalize the current value to lower case
      var curVal = String(value);
      ...
      search.forEach(function (word) {
        var regWord = new RegExp(String(word), 'i');
...
var searchBicyclesSuccess = function searchBicyclesSuccess(data) {
  store.data = data;
  clear.clearAll();
  $('#search-form').show();
  var showBicyclesHtml = searchBicyclesTemplate(matchBicycle(store.targetData, data.bicycles));
  $('.display-results').append(showBicyclesHtml);
  res.showUpdateBicycle();
  res.remove();
  res.showRegisterStolen();
...
var searchBicyclesFailure = function searchBicyclesFailure() {
  $('#message').text('Search error');
};

module.exports = {
  createBicycleSuccess: createBicycleSuccess,
  createBicycleFailure: createBicycleFailure,
  getBicyclesSuccess: getBicyclesSuccess,
  getBicyclesFailure: getBicyclesFailure,
  searchBicyclesSuccess: searchBicyclesSuccess,
  searchBicyclesFailure: searchBicyclesFailure,
  getStolenBicyclesSuccess: getStolenBicyclesSuccess,
  getMyBicyclesSuccess: getMyBicyclesSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onDeleteBicycle = function onDeleteBicycle() {
  api.deleteBicycle().then(ui.deleteBicycleSuccess).catch(ui.deleteBicycleFailure);
};

// update bicycle in database
var onUpdateBicycle = function onUpdateBicycle() {
  event.preventDefault();
  $('#update-bicycle-form').hide();
  var data = getFormFields(event.target);
  api.updateBicycle(data).then(ui.updateBicycleSuccess).catch(ui.updateBicycleFailure);
};

// show the update bike form
var showUpdateBicycle = function showUpdateBicycle() {
  $('.show-update-form').on('click', function () {
    clear.clearAll();
    store.updateId = $(event.target).parent().parent().parent().data('id');
    // looks through the stored bicycles and returns the current bicycle
    var findCurrentBike = function findCurrentBike() {
      return store.data.bicycles.find(function (bike) {
...
var onRegisterStolen = function onRegisterStolen() {
  event.preventDefault();
  $('#register-form').hide();
  var data = getFormFields(event.target);
  api.registerStolen(data).then(ui.registerStolenSuccess).catch(ui.registerStolenFailure);
};

var showRegisterStolen = function showRegisterStolen() {
  $('.register-stolen').on('click', function () {
    clear.clearAll();
    store.updateId = $(event.target).parent().parent().parent().data('id');
...
// deletes a bicycle from the database
var onRecoverStolen = function onRecoverStolen() {
  event.preventDefault();
  $('#recover-form').hide();
  var data = getFormFields(event.target);
  api.recoverStolen(data).then(ui.recoverStolenSuccess).catch(ui.recoverStolenFailure);
};

// recovers a bicycle and deletes stolen event
var showRecoverStolen = function showRecoverStolen() {
...
module.exports = {
  ...
  remove: remove,
  onUpdateBicycle: onUpdateBicycle,
  showUpdateBicycle: showUpdateBicycle,
  showRegisterStolen: showRegisterStolen,
  showRecoverStolen: showRecoverStolen
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var registerStolenFailure = function registerStolenFailure() {
  $('#message').text('Error on bike registration');
};

var recoverStolenSuccess = function recoverStolenSuccess() {
...
var recoverStolenFailure = function recoverStolenFailure() {
  $('#message').text('Error updating bicycle status');
};

module.exports = {
  deleteBicycleSuccess: deleteBicycleSuccess,
  deleteBicycleFailure: deleteBicycleFailure,
  updateBicycleSuccess: updateBicycleSuccess,
  updateBicycleFailure: updateBicycleFailure,
  registerStolenSuccess: registerStolenSuccess,
  registerStolenFailure: registerStolenFailure,
  recoverStolenSuccess: recoverStolenSuccess,
  recoverStolenFailure: recoverStolenFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<div class=\"bicycles\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n  <div class=\"row\">\n  <div class=\"show-left col-xs-1\">\n    <div style=\"background-image: url("
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + ")\"class=\"bike-img-wrap\">\n    <!-- <img class=\"bike-img\" src="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "> -->\n\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.stolen : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "    </div>\n  </div>\n  <div class=\"show-right col-xs-8\">\n    <p class=\"text-left\"><span class=\"attr\">"
    ...
    + "</p>\n    <p class=\"text-left\"><span class=\"attr\">Serial: </span>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.serial_number : stack1), depth0))
    + "</p>\n    <p class=\"text-left\"><span class=\"attr\">Size:</span> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.size : stack1), depth0))
    + "</p>\n  </div>\n\n</div>\n\n<div class=\"row bike-btns\">\n  <div class=\"col-xs-12 text-center\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.program(9, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </div>\n</div>\n\n\n</div>\n\n";
},"2":function(container,depth0,helpers,partials,data) {
    return "      <img class=\"bike-img\" src=\"https://c1.staticflickr.com/5/4685/27234659029_91d9153a46_o.png\">\n      <!-- <h4 class='stolen-label'>STOLEN</h4> -->\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "      <button class=\"bike-btn bike-nav show-update-form\">Update</button>\n      <span>- </span>\n      <button class=\"bike-btn bike-nav remove\">Remove</button>\n      <span>- </span>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[1][0]) != null ? stack1.stolen : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams),"inverse":container.program(7, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"5":function(container,depth0,helpers,partials,data) {
    return "          <button class=\"bike-btn bike-nav recover\">Bike was recovered</button>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "          <button class=\"bike-btn bike-nav register-stolen\">Bike was stolen</button>\n";
},"9":function(container,depth0,helpers,partials,data) {
    return "";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.bicycles : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"bicycles row\" data-id=\""
    ...
    + alias2(alias1((depth0 != null ? depth0.url : depth0), depth0))
    + "> -->\n\n\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.stolen : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "  </div>\n  </div>\n  <div class=\"show-right col-xs-8\">\n    <p class=\"text-left\"><span class=\"attr\">"
    + alias2(alias1((depth0 != null ? depth0.make : depth0), depth0))
    + "</span> "
    ...
    + "</p>\n  </div>\n\n</div>\n\n  <div class=\"row bike-btns\">\n    <div class=\"col-xs-12 text-center\">\n"
    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.editable : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "")
    + "    </div>\n  </div>\n\n  </div>\n\n";
},"2":function(container,depth0,helpers,partials,data) {
    return "  <img class=\"bike-img\" src=\"https://c1.staticflickr.com/5/4685/27234659029_91d9153a46_o.png\">\n    <!-- <h4 class='stolen-label'>STOLEN</h4> -->\n";
  ...
  return "        <button class=\"bike-btn bike-nav show-update-form\">Update</button>\n        <button class=\"bike-btn bike-nav remove\">Remove</button>\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.stolen : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "");
},"5":function(container,depth0,helpers,partials,data) {
    return "            <button class=\"bike-btn bike-nav recover\">Bike was recovered</button>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "            <button class=\"bike-btn bike-nav register-stolen\">Bike was stolen</button>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class='loader-container'>\n  <img src='https://matthewhammondblog.files.wordpress.com/2014/11/wheel-animation.gif' class='loader'>\n  <p>Loading...</p>\n</div>\n";
},"useData":true});
